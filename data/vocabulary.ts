...
export const vocabularyData: Vocabulary[] = [
  ...
  { id: 37, thai: 'การเคลื่อนไหว', english: 'movement', category: 'root' },
  { id: 38, thai: 'ไม่ระบุชื่อ', english: 'anonymous', category: 'root' },
  { id: 39, thai: 'นามปากกา', english: 'pseudonym', category: 'root' },
  { id: 40, thai: 'การขนส่ง', english: 'transport', category: 'root' },
  { id: 41, thai: 'สนามบิน', english: 'airport', category: 'root' },
  { id: 42, thai: 'จิตแพทย์', english: 'psychiatrist', category: 'root' },
  { id: 43, thai: 'การวิเคราะห์ทางจิต', english: 'psychoanalyze', category: 'root' },
  { id: 44, thai: 'ปะทุ', english: 'erupt', category: 'root' },
  ...
  { id: 56, thai: 'การประชุมทางโทรศัพท์', english: 'teleconference', category: 'root' },
  ...
  { id: 64, thai: 'หลักฐาน', english: 'evidence', category: 'root' },
  { id: 65, thai: 'กลับทิศทาง', english: 'reverse', category: 'root' },
  { id: 66, thai: 'หลากหลาย', english: 'diverse', category: 'root' },
  ...
  { id: 85, thai: 'ชุมชน', english: 'community', category: 'prefix' },
  { id: 86, thai: 'เก็บรวบรวม', english: 'collect', category: 'prefix' },
  { id: 87, thai: 'รวมเข้าด้วยกัน', english: 'combine', category: 'prefix' },
  { id: 88, thai: 'ประสานงาน', english: 'coordinate', category: 'prefix' },
  ...
  { id: 98, thai: 'คัดออก', english: 'exclude', category: 'prefix' },
  { id: 99, thai: 'สกัด', english: 'extract', category: 'prefix' },
  { id: 100, thai: 'อดีตประธานาธิบดี', english: 'ex-President', category: 'prefix' },
  ...
  // fore- prefix entries
  { id: 104, thai: 'คาดการณ์', english: 'foresee', category: 'prefix' },
  { id: 105, thai: 'แนวหน้า', english: 'forefront', category: 'prefix' },
  { id: 106, thai: 'บรรพบุรุษ', english: 'forefather', category: 'prefix' },

  // hetero- prefix entries
  { id: 107, thai: 'หลากหลาย', english: 'heterogeneous', category: 'prefix' },
  { id: 108, thai: 'รักเพศตรงข้าม', english: 'heterosexual', category: 'prefix' },

  // homo- prefix entries
  { id: 109, thai: 'สายพันธุ์เดียวกัน', english: 'homozygous', category: 'prefix' },
  { id: 110, thai: 'คำพ้องความหมาย', english: 'homonym', category: 'prefix' },
  ...
  { id: 115, thai: 'ใต้ผิวหนัง', english: 'hypodermic', category: 'prefix' },
  ...
  // inter- prefix entries
  { id: 121, thai: 'ระหว่างประเทศ', english: 'international', category: 'prefix' },
  { id: 122, thai: 'มีปฏิสัมพันธ์', english: 'interact', category: 'prefix' },

  // intra- prefix entries
  { id: 123, thai: 'ในเส้นเลือดดำ', english: 'intravenous', category: 'prefix' },
  { id: 124, thai: 'ภายในเซลล์', english: 'intracellular', category: 'prefix' },

  // macro- prefix entries
  { id: 125, thai: 'โมเลกุลขนาดใหญ่', english: 'macromolecule', category: 'prefix' },
  { id: 126, thai: 'โครงสร้างขนาดใหญ่', english: 'macrostructure', category: 'prefix' },

  // micro- prefix entries
  { id: 127, thai: 'กล้องจุลทรรศน์', english: 'microscope', category: 'prefix' },
  { id: 128, thai: 'จุลชีพ', english: 'microorganism', category: 'prefix' },

  // mis- prefix entries
  { id: 129, thai: 'ตีความผิด', english: 'misinterpret', category: 'prefix' },
  { id: 130, thai: 'ได้ยินผิด', english: 'mishear', category: 'prefix' },

  // multi- prefix entries
  { id: 131, thai: 'หลายวัฒนธรรม', english: 'multicultural', category: 'prefix' },
  { id: 132, thai: 'มัลติฟังก์ชัน', english: 'multifunction', category: 'prefix' },

  // over- prefix entries
  { id: 133, thai: 'บรรทุกเกิน', english: 'overload', category: 'prefix' },
  { id: 134, thai: 'ดูแลอย่างละเอียด', english: 'oversee', category: 'prefix' },
  ...
  // pre- prefix entries
  { id: 138, thai: 'คาดการณ์', english: 'predict', category: 'prefix' },
  ...
  { id: 144, thai: 'เชิงรุก', english: 'proactive', category: 'prefix' },
  { id: 145, thai: 'สนับสนุนประชาธิปไตย', english: 'pro-democracy', category: 'prefix' },

  // re- prefix entries
  { id: 146, thai: 'สร้างใหม่', english: 'rebuild', category: 'prefix' },
  { id: 147, thai: 'เชื่อมต่ออีกครั้ง', english: 'reconnect', category: 'prefix' },
  { id: 148, thai: 'เด้งกลับ', english: 'rebound', category: 'prefix' },

  // sub- prefix entries
  { id: 149, thai: 'วัฒนธรรมย่อย', english: 'subculture', category: 'prefix' },
  { id: 150, thai: 'เรือดำน้ำ', english: 'submarine', category: 'prefix' },

  // super- prefix entries
  { id: 151, thai: 'มหาอำนาจ', english: 'superpower', category: 'prefix' },
  { id: 152, thai: 'ยอดมนุษย์', english: 'superhero', category: 'prefix' },
  { id: 153, thai: 'ซุปเปอร์มาร์เก็ต', english: 'supermarket', category: 'prefix' },

  // trans- prefix entries
  { id: 154, thai: 'เปลี่ยนรูป', english: 'transform', category: 'prefix' },
  { id: 155, thai: 'ปลูกถ่าย', english: 'transplant', category: 'prefix' },
  { id: 156, thai: 'โอน', english: 'transfer', category: 'prefix' },
  { id: 157, thai: 'โปร่งใส', english: 'transparent', category: 'prefix' },

  // under- prefix entries
  { id: 158, thai: 'ประเมินต่ำ', english: 'underestimate', category: 'prefix' },
  { id: 159, thai: 'จ่ายค่าจ้างต่ำ', english: 'underpaid', category: 'prefix' }
];
